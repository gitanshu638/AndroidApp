...
public class BluetoothLEService extends Service {
    ...
    public final static String ACTION_GATT_CONNECTED =
            "com.example.gowheely.bleservice.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED =
            "com.example.gowheely.bleservice.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED =
            "com.example.gowheely.bleservice.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_DATA_AVAILABLE =
            "com.example.gowheely.bleservice.ACTION_DATA_AVAILABLE";
    public final static String EXTRA_DATA =
            "com.example.gowheely.bleservice.EXTRA_DATA";


  //  public final static UUID UUID_BATTERY_LEVEL =
           // UUID.fromString(SampleGattAttributes.UUID_BATTERY_LEVEL_UUID);
    public final static  UUID UUID_CART_INFO = UUID.fromString(SampleGattAttributes.UUID_CART_INFO_SERVICE);
    ...
    private void broadcastUpdate(final String action, final BluetoothGattCharacteristic characteristic) {
        final Intent intent = new Intent(action);
        if (UUID_CART_INFO.equals(characteristic.getUuid())) {
